...
const initiatePostHog = () =>
  posthog.init(import.meta.VITE_POSTHOG_API_KEY, { api_host: "https://app.posthog.com" });

const capturePostHogAnayltics = (analyticsTitle, analyticsProperty, analyticsValue) => {
