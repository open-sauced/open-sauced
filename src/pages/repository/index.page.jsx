        ...
        <SpaceBetweenTop>
          <div>
            <a style={{textDecoration: "none"}} href={url} rel="noreferrer" target="_blank">
              <h1>
                <RepositoryAvatar alt="avatar" src={`https://avatars.githubusercontent.com/${owner}`} />
                {owner}/{name}
              </h1>
            </a>
            {description ? (
            ...
            {/* <DetailInfo text={`${humanizeNumber(issues)} issues`} icon="IssueOpenedIcon" />
            <DetailInfo text={`${humanizeNumber(stargazers)} stars`} icon="StarIcon" />
            {licenseInfo && <DetailInfo text={`${licenseInfo}`} icon="LawIcon" />} */}
            <small>
              <em>
...
// const anon_key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJvbGUiOiJhbm9uIiwiaWF0IjoxNjQyNDU2MTc0LCJleHAiOjE5NTgwMzIxNzR9.c6nlkT05GnNacQ6OYuGcjBsILmGsSDwEEtN2zZVXFgY"
// const supabaseUrl = "https://lkkownkrbkmblczeoyqb.supabase.co"
...
//     .from('repos')
//     .select('full_name, description,issues, stars, watchers, license')
...
//         //     licenseInfo,
//         // }
//         repository: (repository) ? repository[0] : null,
//         error
//     }
// }

// function Repository({match, repository, error, sample}) {
//     const {
//       params: {repoName, repoOwner},
//     } = match;
